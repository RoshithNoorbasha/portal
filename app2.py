...
#     st.markdown("### <i class='fas fa-chart-bar'></i> Inverter Summary", unsafe_allow_html=True)
...
#     st.markdown("---")
#     st.markdown('<i class="fas fa-list"></i> Inverter-wise Summary', unsafe_allow_html=True)
...
#     st.markdown("---")
#     st.markdown('<i class="fas fa-bolt"></i> Detailed PV String Data', unsafe_allow_html=True)
...
#         st.markdown("---")
#         st.markdown('<i class="fas fa-search-plus"></i> Individual Inverter Analysis', unsafe_allow_html=True)
...
def create_pv_string_tab(df):
    ...
    # ==========================================
    # FILTERS SECTION - Using cached options
    # ==========================================
